                ...
                <div className="container mx-auto px-6 lg:px-12 relative z-10">
                    ...
                    <div className="mb-20 space-y-4">
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-10">
                            ...
                            <m.p
                                ...
                                className="text-lg md:text-xl text-primary/60 font-medium max-w-md leading-relaxed"
                            >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8 items-stretch">
                        ...
                        <m.article
                            ...
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            className="md:col-span-12 xl:col-span-5 h-full order-1 xl:order-none"
                        >
                            <div className="h-full bg-primary rounded-[2rem] p-8 md:p-12 flex flex-col justify-between relative overflow-hidden group">
                    ...
                    <m.ul
                        ...
                        viewport={{ once: true }}
                        className="mt-20 pt-10 border-t border-primary/5 flex flex-wrap justify-center gap-x-12 gap-y-4 list-none"
                        aria-label="Service locations and expertise"
                    >
