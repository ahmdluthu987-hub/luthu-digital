                        ...
                        <div className="order-2 lg:order-1 flex flex-col space-y-8 lg:space-y-10">
                            ...
                            >
                                <button
                                    ...
                                    className="group w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-primary text-white px-8 py-4 rounded-full font-bold text-base sm:text-lg hover:bg-primary/90 transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 active:scale-95 text-center"
                                >
