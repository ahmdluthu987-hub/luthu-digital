...
import {
    TestimonialHeaderMotion,
    TestimonialBadgeMotion,
    TestimonialCardMotion,
    TrustIndicatorMotion,
    TestimonialCTAMotion
} from "./testimonials/TestimonialWrappers";
        ...
        <section id="testimonials" className="py-24 md:py-32 bg-[#FDFCF8] relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 lg:px-12 relative z-10">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-24 space-y-8">
                    ...
                    <TestimonialHeaderMotion delay={0.1}>
                        <h2
                    ...
                    <TestimonialHeaderMotion delay={0.2}>
                        <p
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 mb-20 lg:mb-32">
                    {testimonials.map((item, index) => (
                        <TestimonialCardMotion key={index} delay={index * 0.1}>
                ...
                <TestimonialCTAMotion>
                    <Link href="#contact" className="inline-block">
                        <button
                            className="group relative inline-flex items-center justify-center gap-3 px-10 py-5 bg-primary text-white font-bold text-lg sm:text-xl rounded-full shadow-2xl shadow-primary/20 hover:shadow-primary/30 transition-all overflow-hidden cursor-pointer"
                        >
